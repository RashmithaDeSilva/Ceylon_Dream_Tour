...
function ebuwahama(){
    ...
    if(num == 0){  
        ...
        if(bluColCount == 1){
          document.getElementById("inner_quantity1").innerHTML = "Quantity of Blue DC : " + quantity1.value;
          document.getElementById("inner_price1").innerHTML = "Price : " + price1.value;
        }
        if(blackColCount == 1){
            document.getElementById("inner_quantity2").innerHTML = "Quantity of Yellow DC : " + quantity2.value;
            document.getElementById("inner_price2").innerHTML = "Price : " + price2.value;
        }
        if(redColCount == 1){
          document.getElementById("inner_quantity3").innerHTML = "Quantity of Red DC : " + quantity3.value;
