...
function ebuwahama(){
                        ...
                        if(fomat.test(pin.value.trim())){
                            if(Address.value.trim() == "" || Address.value.trim()>10){
                                ...
                                if(blue.checked == true || black.checked == true || red.checked == true){
                                    ...
                                    num += 1 
                                    alert("Please Select Atleast One Set !!!");
                                }
                            }
                        }else{
                            num += 1
    ...
    if(num == 0){  
        ...
        if(bluColCount == 1){
          document.getElementById("inner_quantity1").innerHTML = "Quantity of Set 1 : " + quantity1.value;
          document.getElementById("inner_price1").innerHTML = "Price : " + price1.value;
        }
        if(blackColCount == 1){
            document.getElementById("inner_quantity2").innerHTML = "Quantity of Set 2 : " + quantity2.value;
            document.getElementById("inner_price2").innerHTML = "Price : " + price2.value;
        }
        if(redColCount == 1){
          document.getElementById("inner_quantity3").innerHTML = "Quantity of Set 3 : " + quantity3.value;
