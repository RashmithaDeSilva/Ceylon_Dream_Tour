...
function ebuwahama(){
    ...
    if(num == 0){  
        ...
        if(bluColCount == 1){
          document.getElementById("inner_quantity1").innerHTML = "Quantity of Type 1 : " + quantity1.value;
          document.getElementById("inner_price1").innerHTML = "Price : " + price1.value;
        }
        if(blackColCount == 1){
            document.getElementById("inner_quantity2").innerHTML = "Quantity of Type 2 : " + quantity2.value;
            document.getElementById("inner_price2").innerHTML = "Price : " + price2.value;
        }
        if(redColCount == 1){
          document.getElementById("inner_quantity3").innerHTML = "Quantity of Type 3 : " + quantity3.value;
